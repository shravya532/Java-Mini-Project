...
{  
    ...
    {  
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","shravJ?!2k"); //connecting to database 'qa'
    ...
    void adduserans() //function to connect to qa database and insert user's answers into ua table
    {
        ...
        {
            Class.forName("com.mysql.jdbc.Driver");
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","shravJ?!2k");
            Statement stmt = con.createStatement();
            for(int i=0;i<=3;i++)
            {
    ...
    static void qaoDBcon() //function to connect to qa database and insert question and options into qao table
    {
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","shravJ?!2k");
            Statement stmt = con.createStatement();
            stmt.executeUpdate("insert into qao values(1,'default value of static int variable?','0','1','garbage value','null')");
            stmt.executeUpdate("insert into qao values(2,'Which keyword is used to prevent method overriding?','static','Final','const','Abstract')");
            stmt.executeUpdate("insert into qao values(3,'Which method waits for thread to terminate?','sleep()','isAlive()','join()','stop()')");
            stmt.executeUpdate("insert into qao values(4,'What is finalize?','null','final methd','clears data','garbage collector')");
            stmt.executeUpdate("insert into qao values(5,'Which of these is not abstract?','thread','abstract list','list','None')");
            stmt.executeUpdate("insert into qao values(6,'Which is a type of multitasking','Process','Thread','Process&Thread','None')");
            stmt.executeUpdate("insert into qao values(7,'What is the size of boolean var(in bits)?','8','16','32','None')");
            stmt.executeUpdate("insert into qao values(8,'Strings are?','mutable','immutable','data type','None')");
            stmt.executeUpdate("insert into qao values(9,'Method overriding is: ','Static','Dynamic','both','None')");
            stmt.executeUpdate("insert into qao values(10,'What is the parent of err&Exception classes?','throwable','catchable','MainError','MainException')");
            stmt.executeUpdate("insert into qao values(11,'What's the original name of java?,'Ada','C++','Oak','Lisp')");
    ...
    static void uaDBcon() //function to connect to qa database and insert correct answers of all questions into ua table
    {
        try
        {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql:///qa","root","shravJ?!2k");
            Statement stmt = con.createStatement();
            stmt.executeUpdate("insert into ua values(1,'','0')");
            stmt.executeUpdate("insert into ua values(2,'','Final')");
            stmt.executeUpdate("insert into ua values(3,'','stop()')");
            stmt.executeUpdate("insert into ua values(4,'','clears data')");
            stmt.executeUpdate("insert into ua values(5,'','thread')");
            stmt.executeUpdate("insert into ua values(6,'','Process&Thread')");
            stmt.executeUpdate("insert into ua values(7,'','16')");
            stmt.executeUpdate("insert into ua values(8,'','immutable')");
            stmt.executeUpdate("insert into ua values(9,'','Dynamic')");
            stmt.executeUpdate("insert into ua values(10,'','throwable')");
            stmt.executeUpdate("insert into ua values(11,'','Oak')");
